...
testimonial:
  quote: 'Dans ce projet de reconversion, qui sera un virage radical pour moi, j''ai bénéficié d''un accompagnement très qualitatif de la part de Raphaël, tant en termes d''expertise technique (aquaponie/hydroponie, agroécologie), de posture entrepreneuriale (phasage, planification, business model) et d''état d''esprit (un soutien appréciable lorsque le doute s''est installé). Un mentor que je recommande sans réserve. Merci Raphaël !'
