...
Onglet "Pull Request", créer pull request "New Pull Request", "Base:Master - Compare:new-content", regarder CI "validate-pr" devient vert, "/deploy-beta" dans commentaires; "merge pull request" - "confirm merge"
